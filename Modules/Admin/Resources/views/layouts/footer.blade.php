    ...
    <!-- /page content -->
        ...
        <script type="text/javascript" src="{{ URL::asset('public/admin/js/plugins/loaders/blockui.min.js')}}"></script>
        <!-- /core JS files -->
        ...
        <script type="text/javascript" src="{{ URL::asset('assets/js/plugins/forms/wizards/form_wizard/form.min.js')}}"></script>
        <script type="text/javascript" src="{{ URL::asset('assets/js/plugins/forms/wizards/form_wizard/form_wizard.min.js')}}"></script>
