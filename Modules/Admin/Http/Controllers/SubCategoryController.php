...
class SubCategoryController extends Controller { 
    ...
    public function create(Category $category) 
    {
        ...
        return view('admin::sub_category.create', compact('categories', 'html','category', 'page_title', 'page_action'))->withInput(Input::all());
    }
    ...
    public function edit(Category $category) {
        ...
        return view('admin::sub_category.edit', compact('categories','url','category', 'page_title', 'page_action'));
    }
