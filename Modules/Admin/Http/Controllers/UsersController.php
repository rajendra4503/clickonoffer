...
class UsersController extends Controller
{
    ...
    public function create(User $user)
    {
        ...
        return view('admin::users.create', compact('js_file', 'role_id', 'roles', 'user', 'page_title', 'page_action', 'groups'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('admin::users.edit', compact('js_file', 'role_id', 'roles', 'user', 'page_title', 'page_action'));
    }
